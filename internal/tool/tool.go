...
// MusicProjectManagerTool implements the pluginapi.PluginTool interface.
...
// NewMusicProjectManagerTool creates a new music project manager tool instance
func NewMusicProjectManagerTool(name, version, minAgentVersion, apiVersion string) *MusicProjectManagerTool {
	return &MusicProjectManagerTool{
		BasePlugin: pluginapi.NewBasePlugin(
			name,
			version,
			minAgentVersion,
			"", // maxAgentVersion (no limit)
			apiVersion,
		),
	}
}

// Definition returns the tool definition for the LLM provider.
// Implements pluginapi.PluginTool interface.
...
func (m *MusicProjectManagerTool) Call(ctx context.Context, args string) (string, error) {
	var params types.MusicProjectParams
...
func (m *MusicProjectManagerTool) renameProject(oldName, newName string) (string, error) {
	...
	var projectToRename *types.Project
...
func (m *MusicProjectManagerTool) loadSettingsFromFile() (*types.Settings, error) {
...
func (m *MusicProjectManagerTool) getDefaultSettings() (*types.Settings, error) {
